		...
		while ($fila = $res -> fetch_assoc()) {
			if(CtrlStr::esAdmin($_SESSION['roles'])){
				if($idUsuario!=$fila['idUsuarios']){
					$contenido.='<tr><td><input type="checkbox" id="idUsuarios" name="idUsuarios" value="'.$fila['idUsuarios'].'/">'.'</td><td><input type="text" id="nombre" name="nombre" value="'.$fila['nombre'].'"/></td><td><input type="text" id="correo" name="correo" value="'.$fila['correo'].'"/></td><td>'.$fila['descripcion'].'</td>';	
				}
				else{
				...
				if($idUsuario!=$fila['idUsuarios']){
					$contenido.='<tr id="'.$fila['idUsuarios'].'"><td><input type="text" id="nombre" name="nombre" value="'.$fila['nombre'].'"/></td><td><input type="text" id="correo" name="correo" value="'.$fila['correo'].'"/></td><td>'.$fila['descripcion'].'</td>';	
				}
				else{
					$contenido.='<td>'.$fila['descripcion'].'</td>';
